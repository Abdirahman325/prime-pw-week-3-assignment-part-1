...
// 1.a. TODO: Make an array with some favorite foods
    ...
    let foodArray = ['pizza', 'burgers', 'waffles', 'chips']
...
console.log('First animal is fish', animalArray[0])
...
//      log both the food removed and the updated array
    ...
    console.log('removed fries', removedFood);
...
//     log both the food removed and the updated array
    ...
    console.log('Removed pasta', removedFood);
    console.log('The foods are now', foodArray)
